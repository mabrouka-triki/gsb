...
namespace gsb.Models.MesExceptions
{
    public class MonException : Exception
    {
        private string _utilisateur, _application,
       _systeme;
        private string _support = "Si l'erreur persiste,relevez les messages ci-dessus et prenez contact avec lesupport technique.";
        public MonException()
        {
        ...
        public MonException(string u, string a, string s)
        {
            ...
            if (u != "")
                _utilisateur = u + "\r\n";
            if (a != "")
                _application = "Origine de l'erreur : "
               + a + "\r\n";
            if (s != "")
